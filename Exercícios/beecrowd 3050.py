...
Testes 
------------------
Primeiro exemplo: N=14
A = [2, 3, 1, 6, 4, 3, 7, 5, 6, 4, 5, 3, 1, 1]

distancia do 1 pro 2 :
altura do prédio 1 + altura do prédio 2 + a diferença do número dos prédios (prédio 2 - prédio 1)
= 2 + 3 + 2 - 1 

distância do 1 pro 3: 2 + 1 + 3 -1
distância do 1 pro 4: 2 + 6 + 4 -1 = 11
1 pro 11 : 2 + 5 + 11 - 1

distância do prédio 4 para o 9: 6 + 6 + 9 - 4:  17
distância do prédio 4 para o 11: 6 + 5 + 11 - 4: 18 (distância máxima)
